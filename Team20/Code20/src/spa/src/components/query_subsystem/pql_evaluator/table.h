...
class Table {
 public:
  void AddOneColumn(std::string synonym, std::unordered_set<std::string> possible_single_values);
  void AddTwoColumns(std::string first_synonym, std::string second_synonym,
