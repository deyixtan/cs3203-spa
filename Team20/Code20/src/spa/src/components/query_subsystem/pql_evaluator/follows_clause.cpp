...
FollowsClause::FollowsClause(const std::vector<Declaration> &declarations,
...
Table FollowsClause::HandleWildcardInteger() {
  auto pair_constraints = pkb->GetFollowStore()->GetAllFollowStmt(StmtType::STMT, StmtType::STMT);
