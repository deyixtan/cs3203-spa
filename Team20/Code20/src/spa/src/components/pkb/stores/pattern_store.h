...
class PatternStore : public StatementStore {
 public:
  ...
  void AddWhileWithPattern(std::string const &stmt, std::string const &lhs, std::string const &rhs);
  void AddIfWithPattern(std::string const &stmt, std::string const &lhs, std::string const &rhs);
