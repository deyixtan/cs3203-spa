...
class PatternStore : Store {
 ...
 public:
  ...
  [[nodiscard]] std::unordered_set<std::string> GetStmtWithPatternExact(std::string lhs,
                                                                        std::string rhs); // a("x" / _ , "x")
  [[nodiscard]] std::unordered_set<std::string> GetStmtWithPatternPartial(std::string lhs,
                                                                          std::string rhs); // a("x"/ _, _"x"_)
  ...
  [[nodiscard]] std::unordered_set<std::pair<std::string, std::string>,
                                   pair_hash> GetStmtWithPatternSynonymExact(std::string expr); // a(v, "x")
  [[nodiscard]] std::unordered_set<std::pair<std::string, std::string>,
                                   pair_hash> GetStmtWithPatternSynonymPartial(std::string expr); //a(v, _"x"_)
  [[nodiscard]] std::unordered_set<std::pair<std::string, std::string>,
                                   pair_hash> GetStmtWithPatternSynonymWildcard(); // a(v, _)
