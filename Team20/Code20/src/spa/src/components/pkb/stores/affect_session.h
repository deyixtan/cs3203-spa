...
class AffectSession {
 ...
 public:
  ...
  void TraverseCfg();
  void TraverseCfg(std::shared_ptr<CfgNode> cfg_node, std::unordered_map<std::string, std::string> &last_modified_map);
  void HandleAssignStatement(std::string stmt_no, std::unordered_map<std::string, std::string> &last_modified_map);
  void HandleReadStatement(std::string stmt_no, std::unordered_map<std::string, std::string> &last_modified_map);
  void HandleCallStatement(std::string stmt_no, std::unordered_map<std::string, std::string> &last_modified_map);
  void HandleWhileStatement(std::string stmt_no, std::unordered_map<std::string, std::string> &last_modified_map);
  void HandleIfStatement(std::string stmt_no, std::unordered_map<std::string, std::string> &last_modified_map);
};
