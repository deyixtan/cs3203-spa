...
void ModifyStore::add_stmt_var(std::string stmt, std::string var) {
  stmt_var_pairs.insert(std::make_pair(stmt, var));
}

void ModifyStore::add_proc_var(std::string proc, std::string var) {
  proc_var_pairs.insert(std::make_pair(proc, var));
}

bool ModifyStore::stmt_var_exists(std::pair<std::string, std::string> pair) {
...
std::unordered_set<std::string> ModifyStore::get_var_mod_by_stmt(std::string stmt) {
...
std::unordered_set<std::string> ModifyStore::get_stmt_mod_by_var(std::string var) {
...
std::unordered_set<std::pair<std::string, std::string>, pair_hash> ModifyStore::get_all_stmt_var() {
  return stmt_var_pairs;
}

std::unordered_set<std::pair<std::string, std::string>, pair_hash> ModifyStore::get_all_proc_var() {
