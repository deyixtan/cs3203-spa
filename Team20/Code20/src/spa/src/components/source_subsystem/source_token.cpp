...
std::string SourceToken::GetTypeStr() {
  ...
  switch (type) {
    ...
    case TokenType::WHITE_SPACE:
      type_str = "WHITE_SPACE"; break;
    case TokenType::DIGIT:
      type_str = "DIGIT"; break;
    case TokenType::NAME:
      type_str = "NAME"; break;
    case TokenType::OPENED_BRACES:
      type_str = "OPENED_BRACES"; break;
    case TokenType::CLOSED_BRACES:
      type_str = "CLOSED_BRACES"; break;
    ...
    case TokenType::IS_NOT_EQUAL:
      type_str = "IS_NOT_EQUAL"; break;
    case TokenType::ADDITION:
      type_str = "ADDITION"; break;
    case TokenType::SUBTRACTION:
      type_str = "SUBTRACTION"; break;
    case TokenType::MULTIPLICATION:
      type_str = "MULTIPLICATION"; break;
