...
std::string SourceToken::ToString() {
  ...
  switch (m_type) {
    ...
    case TokenType::OPENED_BRACES: {
      type_str = "OPENED_BRACES";
      break;
    }
    case TokenType::CLOSED_BRACES: {
      type_str = "CLOSED_BRACES";
      break;
    }
    case TokenType::OPENED_PARENTHESIS: {
      type_str = "OPENED_PARENTHESIS";
      break;
    }
    case TokenType::CLOSED_PARENTHESIS: {
      type_str = "CLOSED_PARENTHESIS";
      break;
    }
    case TokenType::AND: {
      type_str = "AND";
