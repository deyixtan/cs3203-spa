...
std::string IfStatementNode::Process(Populator populator, std::vector<std::string>* visited, bool is_uses, std::shared_ptr<source::CfgProcedureNode> cfg_proc_node, std::shared_ptr<source::CfgGroupNode> cfg_node, std::string proc_name) {
  ...
  if_block->Process(populator, visited, false, cfg_proc_node, if_group_node, proc_name);
  else_block->Process(populator, visited, false, cfg_proc_node, else_group_node, proc_name);
